...
uses
  ...
  forms,dialogs, controls, maps, globals ,VMProtectSDK;
...
begin
  ...
  begin
    ...
    begin
        hDevice := CreateFileW(pwidechar('\\.\Nul'),
                      ...
                      0);
      NullDeviceControl.ControlCode:=dwIoControlCode;
      NullDeviceControl.inputBuffer :=lpInBuffer;
    result:=windows.DeviceIoControl(hDevice, 0, @NullDeviceControl,nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpOverlapped );
    closehandle(hDevice);
    end
end;
